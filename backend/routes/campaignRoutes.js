...
router.route('/auction/item/:auctionItemId').get(getAuctionItem).delete(protect, admin, deleteAuctionItem);
...
router.route('/auction/winning-bidder').patch(protect, updateAuctionWinningBidder);
