...
export const BLOG_PUBLIC_DETAILS_REQUEST = 'BLOG_PUBLIC_DETAILS_REQUEST';
export const BLOG_PUBLIC_DETAILS_SUCCESS = 'BLOG_PUBLIC_DETAILS_SUCCESS';
export const BLOG_PUBLIC_DETAILS_FAIL = 'BLOG_PUBLIC_DETAILS_FAIL';
