  ...
  return noWelcomeWienerOrders ? (
    ...
    <Fragment>
        ...
        <div className='flex justify-between items-baseline'>
          <div className='flex  items-baseline'>
            <h1 className='font-Matter-Medium text-2xl mr-2'>
              ${toFixed(dashboard?.welcomeWienerRevenue)}
            </h1>
            <p className='font-Matter-Light text-gray-500 text-sm mr-2'>
              {dashboard?.totalWelcomeWieners} orders
            </p>
          </div>
        </div>
      </div>
      <div className='rounded-xl bg-white overflow-x-scroll lg:overflow-x-hidden relative'>
          ...
          <thead className='whitespace-nowrap px-4 pb-4 pt-2'>
            <tr className='bg-zinc-50'>
              <th className='px-4 border-b border-gray-100 font-Matter-Regular text-star py-2'>
                <div className='text-sm flex whitespace-nowrap items-center gap-2'>Wiener</div>
              </th>
              <th className='px-4 border-b border-gray-100 font-Matter-Regular text-star py-2'>
                <div className=' text-sm flex whitespace-nowrap items-center gap-2'>Product</div>
              </th>
              <th
        ...
        <p className='font-Matter-Light text-gray-600 text-xs px-3 pb-3 pt-8'>
          First order created on{' '}
          {formatDateWithTimezone(dashboard?.firstWelcomeWienerOrderCreatedAt)}
        </p>
      </div>
    </Fragment>
  );
