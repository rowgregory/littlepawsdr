...
export const SqyshMascot = ({ size = 130, onBoop }: { size?: number; onBoop?: () => void }) => {
  ...
  return (
    ...
    >
      ...
      <svg
        ref={svgRef}
        className={`sq-mascot ${booped ? 'booped' : ''} dark:[filter:drop-shadow(0_0_6px_rgba(167,139,250,0.55))_drop-shadow(0_0_16px_rgba(167,139,250,0.35))]`}
        width={size}
        height={size * 1.08}
        viewBox='0 0 240 258'
        aria-hidden='true'
      >
        <defs>
          <linearGradient
            ...
            spreadMethod='repeat'
          >
            <stop offset='0' className='[stop-color:#22d3ee] dark:[stop-color:#c4b5fd]' />
            <stop offset='0.5' className='[stop-color:#0891b2] dark:[stop-color:#a78bfa]' />
            <stop offset='1' className='[stop-color:#22d3ee] dark:[stop-color:#c4b5fd]' />
            <animateTransform
