    ...
    <div className='border-t border-gray-200 pt-6'>
      <div className='flex items-center gap-3 pb-4 border-b border-gray-200 mb-4'>
        ...
        <div>
          ...
          <p className='text-xs text-gray-600 mt-1'>Automated email updates</p>
        </div>
      </div>

      <div className='space-y-3'>
        {auctionNotificationsData.map((obj, i) => (
          <motion.div
            key={obj.textKey}
          ...
          >
            ...
            <div className='flex items-center justify-between pt-3 border-t border-gray-200'>
              <span
                className={`px-2.5 py-1 rounded text-xs font-semibold ${getFrequencyStyle(obj.freq)}`}
              >
                {obj.freq}
              </span>
