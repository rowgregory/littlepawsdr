const BottomInfo = () => {
  return (
    <div className='grid grid-cols-12 gap-5'>
      <div className='col-span-12 md:col-span-4 flex flex-col p-3'>
        <p className='font-bold text-2xl mb-3'>Dogs Adopted in New England</p>
        <p>
      ...
      <div className='col-span-12 md:col-span-4 flex flex-col p-3'>
        <p className='font-bold text-2xl mb-3'>Transportation Help and Distance Restrictions</p>
        <p>
      ...
      <div className='col-span-12 md:col-span-4 flex flex-col p-3'>
        <p className='font-bold text-2xl mb-3'>Adopting across state costs extra</p>
        <p>
