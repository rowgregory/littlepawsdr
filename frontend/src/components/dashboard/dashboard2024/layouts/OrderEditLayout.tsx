...
const Container = styled.div`
  ...
  grid-template-rows: 62px 62px 62px min-content min-content min-content min-content min-content min-content;
  gap: 18px;
  @media screen and (min-width: ${({ theme }) => theme.breakpoints[2]}) {
    grid-template-columns: 1fr 1fr 1fr;
    grid-template-rows: 62px min-content min-content min-content min-content min-content;
  }
`;
...
const OrderEditLayout = ({ box1, box2, box3, box4, box5, box6, box7, box8, box9, error }: any) => {
  return (
    <Container>
