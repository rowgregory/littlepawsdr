...
const Container = styled.div`
  ...
  grid-template-rows: 62px 62px 62px min-content 100px 100px 100px 100px;
  gap: 18px;
  @media screen and (min-width: ${({ theme }) => theme.breakpoints[2]}) {
    grid-template-columns: 1fr 1fr 1fr;
    grid-template-rows: 62px min-content 100px 100px 100px 100px;
  }
`;
...
const EcardEditCreateLayout = ({ box1, box2, box3, box4, box5, box6, box7, box8, error }: any) => {
  return (
    <Container>
...
export default EcardEditCreateLayout