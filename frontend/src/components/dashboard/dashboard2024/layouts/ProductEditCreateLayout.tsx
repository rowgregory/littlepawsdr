...
const Container = styled.div`
  ...
  grid-template-rows: 62px 62px 62px min-content 100px 100px 100px 100px 100px 100px min-content 100px min-content 100px;
  gap: 18px;
  @media screen and (min-width: ${({ theme }) => theme.breakpoints[2]}) {
    grid-template-columns: 1fr 1fr 1fr;
    grid-template-rows: 62px min-content 100px 100px 100px min-content 100px min-content min-content 100px;
  }
`;
...
const ProductEditCreateLayout = ({ box1, box2, box3, box4, box5, box6, box7, box8, box9, box10, box11, box12, box13, box14, error }: any) => {
  return (
    <Container>
      ...
      <GridItem error={error} className='box-12'>
        {box12}
      </GridItem>
      <GridItem error={error} className='box-13'>
        {box13}
      </GridItem>
      <GridItem error={error} className='box-14'>
        {box14}
      </GridItem>
    </Container>
  )
}
export default ProductEditCreateLayout