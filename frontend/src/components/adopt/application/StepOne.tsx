  ...
  return (
    <div className='mt-12 mx-3'>
      <div className='h-[500px] overflow-y-scroll px-3 py-2.5 border-[1px] border-gray-100 rounded-md'>
        <h5 className='font-Matter-Medium mb-1'>Our Mission</h5>
        <p className='font-Matter-Light mb-3.5'>
        ...
        <h5 className='font-Matter-Medium mb-1'>Our Goal</h5>
        <p className='font-Matter-Light mb-3.5'>
        ...
        <h5 className='font-Matter-Medium mb-1'>Application Fee</h5>
        <p className='font-Matter-Light mb-3.5'>
        ...
        <h5 className='font-Matter-Medium mb-1'>Adoption Qualification Requirements</h5>
        <p className='font-Matter-Light mb-3.5'>
        ...
        <ul className='mb-3.5'>
          <li className='mb-2.5 pl-3 font-Matter-Light'>
          ...
          <li className='mb-3.5 pl-3 font-Matter-Light'>
            You must be at least 21 years old to be considered to adopt one of our dogs.
          </li>
        </ul>
        <h5 className='font-Matter-Medium mb-1'>The Adoption Application Process</h5>
        ...
        <h5 className='font-Matter-Medium mb-1'>Virtual Home Visit</h5>
        <p className='font-Matter-Light mb-3.5'>
        ...
        <ul>
          ...
          <li className='mb-2.5 pl-3 font-Matter-Light'>You do not meet the dog’s requirements.</li>
          <li className='mb-2.5 pl-3 font-Matter-Light'>
        ...
        <p className='font-Matter-Light mb-3.5'>
          ...
          <span className='font-Matter-Medium'>15-30 minutes to complete.</span>
        </p>
      </div>
      <button
        onClick={() => setStep((prev: any) => ({ ...prev, step2: true }))}
        className='mt-4 w-full py-2 font-Matter-Medium rounded-md duration-200 bg-yellow-to-green text-white hover:shadow-lg'
      >
