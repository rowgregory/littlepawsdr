    ...
    <Container>
      <InnerContainer ref={scrollableDivRef}>
        ...
        <p>
          ...
          legged breed. We specialize in finding permanent homes for dachshund
          and dachshund mixes. We strive to make the lives of all dogs better
          through action, advocacy, awareness, and education.
        </p>
        <h5>Our Goal</h5>
        <p>
        ...
        <p>
          ...
          family and that the needs of the dog can be met. This will help us to
          ensure that you as the adopter are fully prepared to welcome a new dog
          into your home.
        </p>
        <ul>
          <li>
        ...
        <p>
          Once your application is received it
          will be reviewed by our application coordinator to determine if you
          meet the dog’s requirements.  If your application shows you would a
          good match, the following will take place:
        </p>
        <ul>
        ...
        <ul>
          ...
          <li>
            ...
            we will contact you with more detailed information about why we’re
