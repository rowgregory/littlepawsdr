...
const DarkPreview = () => {
  return (
    ...
    >
      ...
      <rect x='29' y='36' width='48' height='6' rx='3' fill='#26a9df' />
      <rect x='34' y='62' width='64' height='6' rx='3' fill='#a5fe91' />
      <rect x='210' y='36' width='6' height='6' rx='1' fill='#26a9df' />
      <rect x='202' y='36' width='6' height='6' rx='1' fill='#a5fe91' />
