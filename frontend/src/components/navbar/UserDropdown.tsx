  ...
  return (
    <Fragment>
      <aside
        ref={dropDownRef}
        className={`${
          navbar.toggle.userDropdown ? 'block' : 'hidden'
        } z-[3001] fixed top-0 sm:top-[60px] right-0 bottom-0 left-0 sm:left-auto sm:bottom-auto sm:right-6 flex flex-column overflow-hidden sm:shadow-xl sm:max-w-[350px] w-full sm:rounded-2xl bg-slate-100`}
      >
        <div className='p-3'>
          ...
          <div
            className={`bg-[#fff] py-[12px] px-[20px] text-sm font-Matter-Regular flex justify-between items-center mb-[2px] w-full hover:bg-[#D7E2F4] cursor-pointer duration-200 ${
              showMoreLinks ? 'rounded-tl-3xl rounded-tr-3xl' : 'rounded-3xl'
            }`}
            onClick={() => setShowMoreLinks(!showMoreLinks)}
          >
            <p className='text-xs font-Matter-Regular'>
            ...
            <div className='flex items-center justify-end'>
              ...
              <div className='h-5 w-5 rounded-full bg-gray-200 flex items-center justify-center'>
                <i
                  ...
                  } fa-solid fa-chevron-up fa-xs duration-300`}
                ></i>
              </div>
            </div>
          </div>
          <div
            className={`overflow-hidden transition-all duration-200 ease-in-out ${
              showMoreLinks ? 'max-h-[206px]' : 'max-h-[0px]'
            }`}
          >
            <Link
              to='/admin'
            ...
            >
              <i
                className={`col-span-1 fas fa-tachometer-alt fa-md group-hover:text-[#202020]`}
              ></i>
