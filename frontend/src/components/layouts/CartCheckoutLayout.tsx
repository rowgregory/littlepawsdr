...
const CartCheckoutLayout = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <div className='x-auto w-full bg-slate-100 min-h-screen'>
      ...
      >
        <img onClick={() => dispatch(setShowModal(true))} src={WhiteLogo} alt='LPDR' className='w-20 px-2.5' />
        <h1 className='max-w-screen-xl my-auto w-full px-3 text-4xl md:text-6xl font-Matter-Medium text-[#fff]'>Checkout</h1>
      </div>
