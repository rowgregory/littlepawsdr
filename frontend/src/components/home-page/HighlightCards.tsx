...
const HighlightCards = () => {
  return (
    <div className='px-4 sm:px-6 md:px-12 -mt-8 sm:-mt-12 mb-16 md:mb-32 relative z-20'>
      <motion.div
        className='max-w-screen-xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-px sm:bg-border-light sm:dark:bg-border-dark sm:border border-border-light dark:border-border-dark'
      ...
      >
        {hightlightCardData.map((obj, i) => {
          ...
          return (
            <motion.div
              ...
              className='group flex flex-col justify-between gap-4 sm:gap-5 p-5 sm:p-6 xl:p-8 bg-bg-light dark:bg-bg-dark border sm:border-0 border-border-light dark:border-border-dark sm:hover:border-primary-light sm:dark:hover:border-primary-dark transition-colors'
            >
              <div className='w-10 h-10 flex items-center justify-center bg-primary-light/10 dark:bg-primary-dark/10 shrink-0'>
                <IconComponent
              ...
              <div>
                <h2 className='font-changa text-lg sm:text-xl uppercase leading-none text-text-light dark:text-text-dark mb-2 sm:mb-3'>
                  {obj.titleKey}
                </h2>
        ...
        <motion.div
          variants={cardVariants}
          className='group relative overflow-hidden flex flex-col justify-between gap-4 sm:gap-5 p-5 sm:p-6 xl:p-8 bg-primary-light dark:bg-[#1e1b4b]'
        >
          <motion.div
          ...
          <div>
            <h2 className='font-changa text-lg sm:text-xl uppercase leading-none text-white mb-2 sm:mb-3'>
              Adoption Special
            </h2>
