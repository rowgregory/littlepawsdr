...
const ConfirmBidModal: FC<ConfirmBidModalProps> = ({ isOpen, onClose, onConfirm, item, isLoading = false, bidAmount }) => {
  return (
    <AnimatePresence>
      {isOpen && (
        <motion.div
              ...
              <div className='space-y-4 mb-6'>
                <div className='bg-blue-50 border border-blue-200 rounded-xl p-4'>
                  <div className='flex justify-between items-center mb-2'>
                    ...
                    <span className='text-2xl font-black text-blue-600'>${bidAmount.toLocaleString()}</span>
                  </div>
                ...
                <div className='bg-red-50 border border-red-200 rounded-xl p-4'>
                  <div className='flex flex-col sm:flex-row sm:items-start space-x-3'>
                    ...
                    <div>
                      <h4 className='font-semibold text-red-800 mb-1 text-center sm:text-left'>Important Notice</h4>
                ...
                >
                  {isLoading ? (
                    <>
                      ...
                      <span>Placing ${bidAmount} Bid...</span>
                    </>
                  ) : (
                    <>
                      <Gavel className='w-4 h-4' />
                      <span>Confirm ${bidAmount} Bid</span>
                    </>
                  )}
                </button>
              </div>
