...
const AuctionItemDetailsSection: FC<AuctionItemDetailsSectionProps> = ({ campaign, auctionItem }) => {
  return (
    <div className='space-y-4 mb-8 text-white'>
      ...
      <div className='flex justify-between items-center py-4 border-b border-white/10'>
        ...
        <span className='font-semibold text-xs'>{formatDateWithTimezone(campaign?.campaign?.auction?.settings?.startDate)}</span>
      </div>

      <div className='flex justify-between items-center py-4 border-b border-white/10'>
        <span className='font-medium opacity-80'>End Date</span>
        <span className='font-semibold text-xs'>{formatDateWithTimezone(campaign?.campaign?.auction?.settings?.endDate)}</span>
      </div>
      <div className='flex justify-between items-center py-4 border-b border-white/10'>
