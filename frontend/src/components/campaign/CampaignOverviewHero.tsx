...
const CampaignOverviewHero = ({ campaign, theme }: { campaign: any; theme: any }) => {
  return (
    <Fragment>
      <p className='font-Matter-Medium text-3xl lg:text-4xl mb-[20px] text-center lg:text-left'>
        {campaign?.title}
      </p>
      <p className='font-Matter-Light text-[15px] mb-3.5'>{campaign?.subtitle}</p>
      ...
      <div className='flex flex-col lg:flex-row items-start lg:items-center justify-between mt-3'>
        <p className='font-Matter-Light text-xs mb-3.5 lg:mb-0'>
