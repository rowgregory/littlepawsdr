...
import merchAndEcardsCategoriesData from '../../../components/data/merch-and-ecards/merch-and-ecards-categories-data';
    ...
    if (isValid) {
      if (isEditMode) {
        await updateProduct({
          ...
          .unwrap()
          .then(() => navigate('/admin/store/products'))
          .catch((err: any) => err);
      } else {
        await createProduct({
          name: inputs.name,
        ...
        <div className='grid grid-cols-12 gap-3'>
          ...
          <div className='col-span-12 md:col-span-8 md:col-start-6'>
            ...
            <div className='flex flex-col mt-3.5'>
              ...
              >
                {merchAndEcardsCategoriesData.map(
                  (category, i: number) =>
