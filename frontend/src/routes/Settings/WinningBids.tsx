                  ...
                  <Fragment key={bid?._id}>
                    ...
                    >
                      <td className='w-10 h-10'>
                        <i
                          className={`text-gray-700 fas fa-chevron-right fa-xs ml-4 duration-300 origin-center ${openRows?.rows.some((row: any) => row.id === bid._id)
                            ? 'rotate-90'
                            : ''
                            }`}
                        ></i>
                      ...
                      <td className='px-4'>
                        <p
                          className={`${bid?.shippingStatus === 'Complete'
                            ? 'bg-green-100 text-green-500 rounded-3xl'
                            : 'bg-gray-200 text-gray-500 rounded-3xl'
                              ...
                              <div className='grid grid-cols-12 px-4 pb-4 gap-8'>
                                ...
                                {row?.winningBidPaymentStatus === 'Awaiting Payment' && (
                                  <div className='col-span-6 flex items-center justify-center'>
                                    <Link
                                      to={`/auction-items/winner/${row.id}`}
