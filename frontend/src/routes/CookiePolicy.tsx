const CookiePolicy = () => {
  return (
    <div className='max-w-[1450px] w-full px-4 my-32'>
      <p className='text-3xl font-bold mb-5'>Cookies Policy</p>
      ...
      <p className='text-3xl font-bold mb-5'>Interpretation and Definitions</p>
      <p className='text-xl font-bold mb-5'>Interpretation</p>
      <p>
        The words of which the initial letter is capitalized have meanings defined under the
        following conditions. The following definitions shall have the same meaning regardless of
        whether they appear in singular or in plural.
      </p>
      <p className='text-xl font-bold mb-5'>Definitions</p>
      <p>For the purposes of this Cookies Policy:</p>
      <ul>
        <li>
          <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
          &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to Little Paws Dachshund
          Rescue LLC, Our Address Little Paws Dachshund Rescue PO Box 232 College Park, MD 20741.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Little Paws Dachshund Rescue, accessible from{' '}
          <a
            href='https://littlepawsdr.org'
            rel='external nofollow noopener noreferrer'
            target='_blank'
          >
            https://littlepawsdr.org
          </a>
        </li>
        <li>
      ...
      <p className='text-3xl font-bold mb-5'>The use of the Cookies</p>
      <p className='text-xl font-bold mb-5'>Type of Cookies We Use</p>
      <p>
      ...
      <p className='text-xl font-bold mb-5'>Your Choices Regarding Cookies</p>
      <p>
      ...
      <p className='text-xl font-bold mb-5'>More Information about Cookies</p>
      <p>
