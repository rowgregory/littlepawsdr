    ...
    <div className='max-w-[1450px] w-full px-4 my-32'>
      ...
      <ul>
        <li>
          ...
          this Cookies Policy) refers to Little Paws Dachshund Rescue LLC, Our
          Address Little Paws Dachshund Rescue PO Box 232 College Park, MD
          20741.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Little Paws Dachshund Rescue,
          accessible from{' '}
          <a
