      ...
      <div className='px-3'>
        <div className='max-w-screen-lg w-full mx-auto mt-12'>
          ...
          <p className='font-Matter-Light text-lg text-center mb-3'>
            ...
            can learn to trust again, to heal and to learn how to become a loving family member.
            Many of the dachshunds that we pull from shelters or receive from an owner surrender
            just need a temporary home until their new furever home can be found.
          </p>
          ...
          <p className='font-Matter-Light text-lg mb-3'>
            The rescue will provide a handbook on all policy and procedures, pay for all vetting
            care (as outlined in the handbook), monthly heartworm preventative, education and
            support.
          </p>
          <p className='font-Matter-Light text-lg mb-3'>
          ...
          <p className='font-Matter-Light text-lg mb-3'>
            Fostering is a rewarding experience but is a commitment for any person. You will be
            asked to bring home a dog that may have just been pulled out of the shelter into your
            home or one that was surrendered by their owner. Some fosters do not get along with your
            dogs while others will warm up very quickly. There will be some that are sick and will
            need your attention. But the reward when they go to their forever home is something you
            will never forget.
          </p>
          <p className='font-Matter-Light text-lg text-center mb-3'>
