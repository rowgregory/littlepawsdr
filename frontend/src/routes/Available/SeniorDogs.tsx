...
const SeniorDogs = () => {
  return (
    <>
      ...
      <Container>
        <section>
          <Text fontSize='1.5rem'>Top 10 Reasons to Adopt An Older Dog</Text>
          <div className='py-3'>
            {reasonsToAdoptASeniorData().map((obj, i) => (
              ...
              >
                <Text fontSize='1.125rem'>{obj.title}</Text>
        ...
        <div>
          <Text marginBottom='1rem'>
            ...
            more experienced pet owners (age 60 and older) to find a loving
            senior dachshund/dachshund mix to join their home.
          </Text>
          <Text marginBottom='1rem'>
