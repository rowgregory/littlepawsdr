...
import photographerData from '../../components/data/photographer-data';
  ...
  return (
    <Fragment>
      <Hero
        src={ShopHigh}
        title='Merch & Ecards'
        link={photographerData.merch.link}
        photographer={photographerData.merch.name}
      />
      {isLoading && <HorizontalLoader />}
      <div className='max-w-screen-2xl w-full mx-auto mt-12 px-2.5 sm:px-7'>
        {noItems ? (
          <NoItemsAvailable />
        ) : (
