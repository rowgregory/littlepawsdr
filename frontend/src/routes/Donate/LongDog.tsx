...
const LongDog = () => {
  ...
  return (
    ...
    >
      ...
      <h5 className='font-weight-bolder mb-4'>How long 📏 is your dog? 🌭</h5>
      ...
      <form action='https://www.paypal.com/donate' method='post' target='_top'>
        <input type='hidden' name='hosted_button_id' value='5YB4RBLX3H5W8' />
        <DonateBtn
      ...
      <Text fontSize='14px' textAlign='center'>
        USA 🇺🇸 shipping only. International entry/winner would pay own shipping.
        📦
      </Text>
    </div>
  );
